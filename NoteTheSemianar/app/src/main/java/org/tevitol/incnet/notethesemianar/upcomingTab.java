 ...
 */
public class upcomingTab extends Activity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.tab_upcoming);

        TextView tv = (TextView) findViewById(R.id.add_event_upcoming);
        ...
        try {
            ...
            ListView listView = (ListView) findViewById(R.id.upcoming_list_view);
